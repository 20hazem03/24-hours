...
//----------------------------unflip the card and continue playing-----------------
          ...
          var inner3 = imagecontainer[2].querySelector('.flip-card-inner')
          inner1.classList.toggle("flip")
          inner2.classList.toggle("flip")
          inner3.classList.toggle("flip")
          imagecouple = []
          imagecontainer = []
        }, 1000)
      }
